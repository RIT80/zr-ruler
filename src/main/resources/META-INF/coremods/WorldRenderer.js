                    ...
                    if (method.name === render) {
                        ...
                        for (j in insnArray) {
                            ...
                            if (instruction instanceof LabelNode) {
                                ...
                                instructions.insertBefore(instruction, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/zaqrit/minecraft/forgemod/zrruler/client/ZrRulerClient", "renderWorldLast", "()V", false));
                                break;
                            }
                        }
                        break;
